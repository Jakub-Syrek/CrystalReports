...
namespace CrystalReportsEntity1.DataSet1TableAdapters {
...
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath, Salary FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [T" +
                ...
                "tsTo, [PhotoPath] = @PhotoPath, [Salary] = @Salary WHERE (([EmployeeID] = @Origi" +
                "nal_EmployeeID) AND ([LastName] = @Original_LastName) AND ([FirstName] = @Origin" +
                "al_FirstName) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Origin" +
                "al_Title)) AND ((@IsNull_TitleOfCourtesy = 1 AND [TitleOfCourtesy] IS NULL) OR (" +
                "[TitleOfCourtesy] = @Original_TitleOfCourtesy)) AND ((@IsNull_BirthDate = 1 AND " +
                "[BirthDate] IS NULL) OR ([BirthDate] = @Original_BirthDate)) AND ((@IsNull_HireD" +
                "ate = 1 AND [HireDate] IS NULL) OR ([HireDate] = @Original_HireDate)) AND ((@IsN" +
                ...
                "l_Region = 1 AND [Region] IS NULL) OR ([Region] = @Original_Region)) AND ((@IsNu" +
                "ll_PostalCode = 1 AND [PostalCode] IS NULL) OR ([PostalCode] = @Original_PostalC" +
                "ode)) AND ((@IsNull_Country = 1 AND [Country] IS NULL) OR ([Country] = @Original" +
                "_Country)) AND ((@IsNull_HomePhone = 1 AND [HomePhone] IS NULL) OR ([HomePhone] " +
                "= @Original_HomePhone)) AND ((@IsNull_Extension = 1 AND [Extension] IS NULL) OR " +
                "([Extension] = @Original_Extension)) AND ((@IsNull_ReportsTo = 1 AND [ReportsTo]" +
                " IS NULL) OR ([ReportsTo] = @Original_ReportsTo)) AND ((@IsNull_PhotoPath = 1 AN" +
                "D [PhotoPath] IS NULL) OR ([PhotoPath] = @Original_PhotoPath)) AND ((@IsNull_Sal" +
                "ary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)));\r\nSELECT Employ" +
                "eeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address," +
                " City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsT" +
                "o, PhotoPath, Salary FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CrystalReportsEntity1.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDa" +
                ...
                "es, ReportsTo, PhotoPath, Salary FROM dbo.Employees";
        ...
        public virtual int Insert(
            ...
            if ((Salary.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[17].Value = ((decimal)(Salary.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((Salary.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[17].Value = ((decimal)(Salary.Value));
            }
            else {
            ...
            if ((Original_Salary.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[48].Value = ((decimal)(Original_Salary.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_PhotoPath, 
                    global::System.Nullable<decimal> Original_Salary) {
            return this.Update(LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath, Salary, Original_EmployeeID, Original_LastName, Original_FirstName, Original_Title, Original_TitleOfCourtesy, Original_BirthDate, Original_HireDate, Original_Address, Original_City, Original_Region, Original_PostalCode, Original_Country, Original_HomePhone, Original_Extension, Original_ReportsTo, Original_PhotoPath, Original_Salary, Original_EmployeeID);
        }
    }
